...
python src/evaluation.py "predictions/legacy_predictions/icnale-baseline.fce.predictions" fce base 10 "images/output_icnale_10.png"

python src/evaluation.py "predictions/legacy_predictions/ell-baseline.fce.predictions" fce base 10 "images/output_ell_10.png"

python src/evaluation.py "predictions/legacy_predictions/icnale-baseline-categories.fce.predictions" fce base 10 "images/output_icnale_categories_10.png"

python src/evaluation.py "predictions/legacy_predictions/double-pretrain.fce.predictions" fce base 10 "images/output_double_pretrain_10.png"

python src/evaluation.py "predictions/legacy_predictions/hierarchical-baseline.fce.predictions" fce base 10 "images/output_hierarchical_10.png"
...
python src/evaluation.py "predictions/legacy_predictions/icnale-baseline.fce.predictions" fce base 5 "images/output_icnale_5.png"

python src/evaluation.py "predictions/legacy_predictions/ell-baseline.fce.predictions" fce base 5 "images/output_ell_5.png"

python src/evaluation.py "predictions/legacy_predictions/icnale-baseline-categories.fce.predictions" fce base 5 "images/output_icnale_categories_5.png"

python src/evaluation.py "predictions/legacy_predictions/double-pretrain.fce.predictions" fce base 5 "images/output_double_pretrain_5.png"

python src/evaluation.py "predictions/legacy_predictions/hierarchical-baseline.fce.predictions" fce base 5 "images/output_hierarchical_5.png"
...
python src/evaluation-ensemble.py 2 "predictions/legacy_predictions/hierarchical-baseline.fce.predictions" icnale-baseline-more-drop.fce.predictions 1 2 fce 10 "images/output_iter_icnale_10.png" "images/output_iter_icnale_10-hist.png" "Ensemble Model Confusion Matrix"

python src/evaluation-ensemble.py 2 "predictions/legacy_predictions/hierarchical-baseline.fce.predictions" icnale-baseline-more-drop.fce.predictions 1 2 fce 5 "images/output_iter_icnale_5.png"