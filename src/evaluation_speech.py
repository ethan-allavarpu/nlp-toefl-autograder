...
if __name__ == "__main__":
    ...
    for col in pred_cols:
        rmse = np.sqrt(mean_squared_error(nlp_preds[col], nlp_preds[actual_cols[pred_cols.index(col)]]))
        r2 = r2_score(nlp_preds[col], nlp_preds[actual_cols[pred_cols.index(col)]])
